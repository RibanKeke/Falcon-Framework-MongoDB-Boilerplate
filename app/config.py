...
g.add_argument("--env_vars_prefix", type=str, default="mf",
               help="Prefix for environment variables (default %(default)s)")
g.add_argument("--mongo_uri", type=str, default={}, help="MongoDB configuration:"
                                                            "{db,username,password,host,port}")
g.add_argument("--db_name", type=str, default="appdb", help="Mongo database name")
...
gu.add_argument("--workers", type=int, default=0,
               help="The number of worker processes for handling requests. "
                    ...
                    "(default %(default)s)")
gu.add_argument("--reload", action="store_true", help="Reload the server on file change")
gu.add_argument("--timeout", type=int, default=30, help="Timeout for gunicorn workers")
gu.add_argument("--graceful-timeout", type=int, default=30, help="Timeout for gunicorn workers when asked to restart")
